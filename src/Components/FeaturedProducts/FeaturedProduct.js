...
const FeaturedProduct = ({ type }) => {
    return (
        <div className='FeaturedProducts'>
            <div className="top">
                <h1>{type}Product</h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium quasi impedit quibusdam, quis sit esse illo unde placeat id, eos nobis, a fuga officiis ut odio inventore dignissimos sint minus consequuntur. Quis fuga doloremque eius.</p>
            </div>
